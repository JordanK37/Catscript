package edu.montana.csci.csci466.util;
...
public class Web {
    ...
    private static edu.montana.csci.csci466.util.Web INSTANCE = new edu.montana.csci.csci466.util.Web();
    ...
    public static void init() {
        before((request, response) -> {
            ...
            edu.montana.csci.csci466.util.Web.set(request, response, System.currentTimeMillis());
        });
        ...
        exception(Exception.class, (e, request, response) -> {
            ...
            response.status(500);
            response.body(edu.montana.csci.csci466.util.Web.renderTemplate("templates/error.vm",
                    "error", e,
